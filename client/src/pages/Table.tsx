        ...
        <div className="bg-white white:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
          <div className="flex flex-col md:flex-row items-center justify-between space-y-3 md:space-y-0 md:space-x-4 p-4">
            ...
            <div className="w-full md:w-auto flex flex-col md:flex-row space-y-2 md:space-y-0 items-stretch md:items-center justify-end md:space-x-3 flex-shrink-0">
              ...
              <div className="flex items-center space-x-3 w-full md:w-auto">
                ...
                <div
                  id="actionsDropdown"
                  className="hidden z-10 w-44 bg-white rounded divide-y divide-gray-100 shadow white:bg-gray-700 white:divide-gray-600"
                >
                  <ul
                    className="py-1 text-sm text-gray-700 white:text-gray-200"
                    aria-labelledby="actionsDropdownButton"
                  >
                    <li>
                      <a
                        href="#"
                        className="block py-2 px-4 hover:bg-gray-100 white:hover:bg-gray-600 white:hover:text-white"
                      >
                        Mass Edit
                      </a>
                    </li>
                  ...
                  <div className="py-1">
                    <a
                      href="#"
                      className="block py-2 px-4 text-sm text-gray-700 hover:bg-gray-100 white:hover:bg-gray-600 white:text-gray-200 white:hover:text-white"
                    >
                      Delete all
                    </a>
                  </div>
                ...
                <div
                  id="filterDropdown"
                  className="z-10 hidden w-48 p-3 bg-white rounded-lg shadow white:bg-gray-700"
                >
                  <h6 className="mb-3 text-sm font-medium text-gray-900 white:text-white">
                    Choose brand
                  </h6>
                  <ul
                  ...
                  >
                    <li className="flex items-center">
                      <input
                        ...
                        type="checkbox"
                        value=""
                        className="w-4 h-4 bg-gray-100 border-gray-300 rounded text-primary-600 focus:ring-primary-500 white:focus:ring-primary-600 white:ring-offset-gray-700 focus:ring-2 white:bg-gray-600 white:border-gray-500"
                      />
                      <label
                        htmlFor="apple"
                        className="ml-2 text-sm font-medium text-gray-900 white:text-gray-100"
                      >
                        Apple (56)
                      </label>
                    </li>
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-sm text-left text-gray-500 white:text-gray-400">
              ...
              <tbody>
                <tr className="border-b white:border-gray-700">
                  <th
                    scope="row"
                    className="px-4 py-3 font-medium text-gray-900 whitespace-nowrap white:text-white"
                  >
                    Apple iMac 27&#34;
                  </th>
                  ...
                  <td className="px-4 py-3 flex items-center justify-end">
                    <button
                      ...
                      className="inline-flex items-center p-0.5 text-sm font-medium text-center text-gray-500 hover:text-gray-800 rounded-lg focus:outline-none white:text-gray-400 white:hover:text-gray-100"
                      type="button"
                    >
                      <svg
                        className="w-5 h-5"
          ...
          >
            ...
            <ul className="inline-flex items-stretch -space-x-px">
              <li>
                <a
                  href="#"
                  className="flex items-center justify-center h-full py-1.5 px-3 ml-0 text-gray-500 bg-white rounded-l-lg border border-gray-300 hover:bg-gray-100 hover:text-gray-700 white:bg-gray-800 white:border-gray-700 white:text-gray-400 white:hover:bg-gray-700 white:hover:text-white"
                >
              ...
              <li>
                <a
                  href="#"
                  className="flex items-center justify-center text-sm py-2 px-3 leading-tight text-gray-500 bg-white border border-gray-300 hover:bg-gray-100 hover:text-gray-700 white:bg-gray-800 white:border-gray-700 white:text-gray-400 white:hover:bg-gray-700 white:hover:text-white"
                >
                  1
                </a>
              </li>
              ...
              <li>
                <a
                  href="#"
                  aria-current="page"
                  className="flex items-center justify-center text-sm z-10 py-2 px-3 leading-tight text-primary-600 bg-primary-50 border border-primary-300 hover:bg-primary-100 hover:text-primary-700 white:border-gray-700 white:bg-gray-700 white:text-white"
                >
                  3
                </a>
              </li>
              ...
              <li>
                <a
                  href="#"
                  className="flex items-center justify-center h-full py-1.5 px-3 leading-tight text-gray-500 bg-white rounded-r-lg border border-gray-300 hover:bg-gray-100 hover:text-gray-700 white:bg-gray-800 white:border-gray-700 white:text-gray-400 white:hover:bg-gray-700 white:hover:text-white"
                >
